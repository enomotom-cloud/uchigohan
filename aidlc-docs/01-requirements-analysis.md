...
うちごはんの差別化は単一機能ではなく、3軸の同時提供にあります。
各軸で勝てる相手が異なるため、競合参入に対する多重防衛になります。

| 軸 | 内容 | 競合との差 |
|---|---|---|
| 現在性 | 今日の体調・疲労・在庫をリアルタイム統合した献立 | クラシル等は静的レシピDB、Oisix等は1週間前計画 |
| 愛情 | "誰かが、今日のあなたのために作った" 事実の保護 | ナッシュ等は工場製、誰のためでもない |
| チャレンジ | 楽天レシピAPI×AIで家庭の "いつもの味" に新提案 | 従来の家庭料理は作り手の得意料理に固定化 |
